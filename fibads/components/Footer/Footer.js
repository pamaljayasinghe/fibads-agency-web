          ...
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <p className="footer-description">
                ...
                oplossingen die echte resultaten leveren.
              </p>
            ...
            <div className="footer-links">
              <h3 className="footer-heading">Diensten</h3>
              <ul className="footer-menu">
                <li>
                  <a href="/diensten/google-ads" className="footer-link">
                    Google Ads
                  </a>
                </li>
                <li>
                  <a href="/diensten/social-media" className="footer-link">
                    Social Media
                  </a>
                </li>
                <li>
                  <a href="/diensten/webdesign" className="footer-link">
                    Webdesign
                  </a>
                </li>
                <li>
                  <a href="/diensten/branding" className="footer-link">
                    Branding
                  </a>
                </li>
              </ul>
            ...
            <div className="footer-links">
              ...
              <ul className="footer-menu">
                <li>
                  <a href="/over-ons" className="footer-link">
                    Over ons
                  </a>
                </li>
                <li>
                  <a href="/cases" className="footer-link">
                    Cases
                  </a>
                </li>
                <li>
            ...
            <div className="footer-links">
              ...
              <ul className="footer-contact">
                ...
                <li className="contact-item">
                  ...
                  <a href="mailto:info@fibdigital.nl">info@fibdigital.nl</a>
                </li>
                <li className="contact-item">
                  <svg
                    width="18"
        ...
        <div className="container">
          <div className="footer-bottom-content">
            ...
            <div className="footer-legal">
              ...
              <a href="/privacy-beleid" className="legal-link">
                Privacy Beleid
              </a>
            </div>
          </div>
